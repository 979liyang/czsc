...
3）采集指定上证股票（逗号分隔）
    ...
    python scripts/fetch_tushare_minute_data_stk_mins_sh.py --freq 1min --start-date "2018-01-01 09:00:00" --end-date "2026-02-02 19:00:00" --stocks 600078.SH 
...
7）断点续跑（从某只股票之后继续）
    ...
    python scripts/fetch_tushare_minute_data_stk_mins_sh.py --freq 1min --start-date "2018-01-01 09:00:00" --end-date "2026-02-02 19:00:00" --resume-after 688602.SH
